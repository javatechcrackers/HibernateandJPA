...
public class CompanyHome {
	...
	public Company findById(int id) {
		...
		try {
			Company instance = (Company) sessionFactory.getCurrentSession().get("Company", id);
			if (instance == null) {
	...
	public List findByExample(Company instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Company").add(Example.create(instance))
					.list();
