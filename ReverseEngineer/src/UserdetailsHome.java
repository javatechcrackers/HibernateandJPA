...
public class UserdetailsHome {
	...
	public Userdetails merge(Userdetails detachedInstance) {
		...
		try {
			Userdetails result = (Userdetails) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Userdetails findById(int id) {
		...
		try {
			Userdetails instance = (Userdetails) sessionFactory.getCurrentSession().get("Userdetails", id);
			if (instance == null) {
	...
	public List findByExample(Userdetails instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Userdetails")
